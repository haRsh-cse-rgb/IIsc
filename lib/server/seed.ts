...
const seedDatabase = async () => {
  try {
    ...
    // Menu is now stored in JSON file, no need to delete from DB
    ...
    // Menu items are now stored in app/menu/menu.json and loaded directly by the menu page
    ...
    console.log(`🍽️  Menu items are loaded from app/menu/menu.json\n`);
